...
async function createFinalFields() {
    console.log('🚀 Criando ultimos campos pendentes de maneira espaçada...');
    ...
    for (const field of fieldsToCreate) {
        try {
            ...
            console.log(`✅ Esperando 2 segundos para o próximo...`);
            await delay(2000);
        } catch (e) {
            console.error(`⚠️ Erro criar ${field.key}:`, e.message);
        }
    }
