...
ja estamos em uma vps com swarm, 2 maquinas pequenas porem ligadas na mesma rede, uma maquina com, postgres, redis, appwrite, a outra com minio e traeffik.Ainda pequenas no periodo de desenvolvimento, 2cpu, 4Ram e 40gb

Sim repasse automático/split, orientaremos todos a abrir uma conta no asaas atraves de link de afiliado

Sim faremos aprovação dos produtores e dos eventos, porém a não aprovação do produtor não tira o direito de criar o evento, publicar só depois de passar com o pessoal da qualidade

A foto para biometria não(em primeiro plano) , apenas como item de segurança para avaliação do staff.

alguns minutos, objetivo treinar uma IA para essa aprovação e suporte