...
BUG-HOM-006 — Credencial/QR antes da confirmação financeira — CORRIGIDO LOCALMENTE — AGUARDANDO DEPLOY/HOMOLOGAÇÃO
BUG-HOM-007 — Painel produtor replica comprador em vez dos participantes — CORRIGIDO LOCALMENTE — AGUARDANDO DEPLOY/HOMOLOGAÇÃO
