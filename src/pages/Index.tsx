      ...
      <div className="pb-20 bg-gray-50">
        ...
        <section className="max-w-7xl mx-auto px-4 -mt-16 relative z-30">
          <div className="bg-white rounded-[3rem] shadow-2xl p-8 grid grid-cols-2 lg:grid-cols-4 gap-8 border border-gray-100">
            {[
              { label: 'Música', icon: Music, color: 'text-pink-600', bg: 'bg-pink-50', id: 'Show / Concerto' },
              { label: 'Teatro', icon: Sparkles, color: 'text-purple-600', bg: 'bg-purple-50', id: 'Teatro' },
              { label: 'Workshops', icon: Laptop, color: 'text-blue-600', bg: 'bg-blue-50', id: 'Palestra / Workshop' },
              { label: 'Festas', icon: Heart, color: 'text-red-600', bg: 'bg-red-50', id: 'Festa / Balada' },
            ].map((cat, i) => (
              <Link
                key={i}
              ...
              allEvents.slice(0, 8).map(event => (
                ...
                >
                  <div className="relative h-48 overflow-hidden">
                    ...
                    />
                    <div className="absolute top-4 left-4 bg-white/95 backdrop-blur px-4 py-1.5 rounded-full text-[10px] font-black text-indigo-600 shadow-lg uppercase tracking-widest border border-indigo-100/50">
                      {event.category?.split(' / ')[0] || 'EVENTO'}
                    </div>
                  </div>
        ...
        {[
          { title: 'Shows e Música', id: 'Show / Concerto' },
          { title: 'Workshops e Cursos', id: 'Palestra / Workshop' },
          { title: 'Teatro e Arte', id: 'Teatro' }
        ].map((cat) => (
