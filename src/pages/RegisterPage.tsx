...
const RegisterPage = () => {
  ...
  const onSubmit = async (data: RegisterFormData) => {
    ...
    try {
      ...
      } else if (result.error && result.error.includes('em uso')) {
          ...
          <DialogContent className="sm:max-w-md bg-[#0A0A0A] border-white/5 rounded-3xl p-8 text-center">
            ...
            <DialogHeader className="space-y-4">
              ...
              <DialogDescription className="text-gray-400 text-base leading-relaxed">
                Seu perfil de staff foi criado com sucesso! <br />
                Para ativar sua conta e acessar as propostas, faça seu primeiro login individual abaixo.
              </DialogDescription>
            </DialogHeader>
            <div className="mt-8 space-y-4">
              <Button 
                onClick={() => navigate('/staff/portal/profile')}
              ...
              <p className="text-[10px] text-gray-600 font-bold uppercase tracking-widest">
                Você será redirecionado para o seu portal de trabalho.
              </p>
            </div>
          </DialogContent>
        </Dialog>
